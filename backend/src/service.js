...
const apiService = {
    ...
    async getPosts(categoryFilter) {
        return await postsRepo.getPosts(categoryFilter);
    },
    ...
    async getComments(postIdFilter) {
        return await commentsRepo.getComments(postIdFilter);
    },
